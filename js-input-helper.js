...
program
	...
	mv('project-template.js',project_name+'.js');
	mv('project-template.xml',project_name+'.xml');
	sed('-i',/@PROJECT-NAME@/g,project_name,project_name+'.html');
	sed('-i',/project-template/g,project_name,project_name+'.html');
	sed('-i',/@PROJECT-NAME@/g,project_name,project_name+'.xml');
	sed('-i',/@PROJECT-NAME@/g,project_name,'README.md');
